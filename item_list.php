...
<body>
    ...
    $pdo = require 'pdo/PDOConnection.php';
...
INNER JOIN 
    ratings
USING (item_id) WHERE item_cat = :item_cat GROUP BY ratings.item_id, item_name, avg_rating, tot_sales, item_desc, item_img 
ORDER BY 
...
LIMIT 10;";
    ...
    $stmnt->bindParam(':item_cat', $cat_id, PDO::PARAM_INT);
    $stmnt->execute();
